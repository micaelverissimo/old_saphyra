...
merge_all = Concatenate(axis=1)([conv1_ps,conv1_em1,conv1_em2,conv1_em3])
...
model     = Model( [input_ps,input_em1,input_em2,input_em3], output )
...
createPandaJobs( models        = [model],
        ...
        nSortsPerJob  = 1,
        nModelsPerJob = 1,
        outputFolder  = 'job_config.Jpsi_ringer.v4_nohad.RingerNet.10sorts.5inits'
        )
