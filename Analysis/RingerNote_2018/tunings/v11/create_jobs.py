...
conv1d_2_em1  = Conv1D( 8, kernel_size=2, activation='relu', name='conv1d_2_em1' )(conv1d_1_em1)
em1 = Reshape( (6,8,1), name='reshape_2_em1' )(conv1d_2_em1)
#
# Eletromagnetic EM2
#
...
#
# Eletronic merge (Longitudinal exploration), output is (None, 6, 8, 4)
merge_em = Concatenate(axis=3, name='concat_em')([ps,em1,em2,em3])
conv2d_1_em_merged = Conv2D( 16, kernel_size=(1,1), activation='relu', name='conv2d_1_em_merged')(merge_em) # output is (None, 6, 8, 16)
...
conv2d_1_had_merged = Conv2D( 16, kernel_size=(1,1), activation='relu', name='conv2d_1_had_merged')(merge_had) # output is (None, 2, 8, 16
