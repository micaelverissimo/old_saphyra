...
def GridParser():
  ...
  gridParserGroup.add_job_submission_csv_option('--excludedSite', 
      ...
      default = 'ANALY_DESY-HH_UCORE,ANALY_BNL_MCORE,ANALY_MWT2_SL6,ANALY_MWT2_HIMEM,ANALY_DESY-HH,ANALY_FZK_UCORE,ANALY_FZU,DESY-HH_UCORE,FZK-LCG2_UCORE,ANALY_SFU_T2',
      #default = '',
