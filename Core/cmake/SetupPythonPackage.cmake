...
function( setup_python_package name file md5 )
   ...
   cmake_parse_arguments( ARG "SINGLE_VERSION" ""
     "DEPENDS;EXTRA_ARGS;PATCH" "SETUP" ${ARGN} )
   ...
   set( _SETUP_PY_PATH setup.py )
   if ( ARG_SETUP )
     set( _SETUP_PY_PATH ${ARG_SETUP} )
   endif()
   ...
   ExternalProject_Add( ${name}
      ...
      python ${_SETUP_PY_PATH} ${ARG_EXTRA_ARGS} build
      ...
      python ${_SETUP_PY_PATH} ${ARG_EXTRA_ARGS} install
   ...
   add_dependencies( Package_TuningTools ${name} )
   ...
   set_property( TARGET ${name} PROPERTY LABEL TuningTools )
