...
start = timer()
DatasetLocationInput = '/home/jodafons/Public/ringer/root/TuningTools/scripts/analysis_scripts/Offline_mc16_201802XX_v6/data/files/mc16track_lhgrid_v3/mc16a.zee.20M.jf17.20M.offline.binned.track.wdatadrivenlh_et2_eta0.npz'
...
tuningJob( DatasetLocationInput, 
           ...
           etBins = 2,
           etaBins = 0,
           ppFile = 'data/files/user.jodafons.ppFile_TrackSimpleNorm.pic.gz/ppFile_TrackSimpleNorm.pic.gz',
           refFile = 'data/files/mc16track_lhgrid_v3/mc16a.zee.20M.jf17.20M.offline.binned.track.wdatadrivenlh_eff.npz',
